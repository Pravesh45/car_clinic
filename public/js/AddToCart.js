...
button1.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/1', options).then(res => res.json()).then(data => {
...
button2.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/3', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button3.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/4', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button4.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/5', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button5.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/6', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button6.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/7', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button7.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/8', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button8.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/9', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button9.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/10', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
...
button15.addEventListener('click', (e) => {
    ...
    fetch('http://localhost:3000/AddToCart/2', options).then(res => res.json()).then(data => {
        if (data.message == "Please Provide Authentication") {
            window.location.replace("http://localhost:3000/login")
        }
        if (data.length) {
